!function (e, t) {
  ...
  return function (e) {
    ...
    (function () {
      ...
      var u = this, c = u._, l = Array.prototype, f = Object.prototype, h = Function.prototype, d = l.push, p = l.slice, _ = f.toString,
        v = f.hasOwnProperty, y = Array.isArray, m = Object.keys, g = h.bind, b = Object.create, w = function () {
        }, S = function (e) {
      ...
      var L = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, q = S.invert(L), F = function (e) {
        var t = function (t) {
          return e[t]
      ...
      S.template = function (e, t, n) {
        ...
        var r = RegExp([(t.escape || J).source, (t.interpolate || J).source, (t.evaluate || J).source].join("|") + "|$", "g"), i = 0, o = "__p+='";
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      }, i = n(7), o = n(5)("leancloud:request"), s = n(57), a = n(1), u = n(16), c = n(3), l = n(6), f = n(0), h = n(4), d = h.getSessionToken, p = void 0,
      _ = {cn: "https://api.leancloud.cn", us: "https://us-api.leancloud.cn"}, v = function (e, t) {
        ...
        var r = arguments.length <= 3 || void 0 === arguments[3] ? {} : arguments[3], s = arguments[4], u = y++;
    ...
    e.exports = {ajax: m, request: T, setServerUrlByRegion: j}
  }, function (e, t, n) {
    "use strict";
    ...
    e.exports = {isNullOrUndefined: i, ensureArray: o, getSessionToken: s, tap: a}
  }, function (e, t, n) {
    function r() {
    ...
    "use strict";
    (function (t) {
      var r = n(0), i = n(41), o = n(4), s = o.isNullOrUndefined, a = t.AV || {};
      a._config = a._config || {};
      var u = a._config;
      r.extend(u, {region: "cn", APIServerURL: u.APIServerURL || "", disableCurrentUser: !1, userAgent: i, applicationProduction: null});
      var c = function () {
      }, l = function (e, t, n) {
        var i;
      ...
      a.setProduction = function (e) {
        ...
        if (!n) return null;
        var r = n[1] || 0, i = (n[2] || 1) - 1, o = n[3] || 0, s = n[4] || 0, a = n[5] || 0, u = n[6] || 0, c = n[8] || 0;
        ...
        if (r.isDate(e)) return i ? {__type: "Date", iso: e.toJSON()} : e.toJSON();
    ...
    function o(e, t, n) {
      if (null != n) if (Array.isArray(n)) n.forEach(function (n) {
        o(e, t, n)
      }); else if (_(n)) for (var r in n) o(e, t + "[" + r + "]", n[r]); else e.push(encodeURIComponent(t) + "=" + encodeURIComponent(n)); else null === n && e.push(encodeURIComponent(t))
    }
    ...
    var d = n(48), p = n(59), _ = n(11), v = n(58), y = n(60), m = t = e.exports = function (e, n) {
    ...
    m.serializeObject = i, m.parseString = s, m.types = {
    ...
    }, m.serialize = {"application/x-www-form-urlencoded": i, "application/json": JSON.stringify}, m.parse = {
      ...
      try {
        this.username && this.password ? n.openSidebar(this.method, this.url, !0, this.username, this.password) : n.openSidebar(this.method, this.url, !0)
      } catch (e) {
      ...
      if (this._withCredentials && (n.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof i && !this._isHost(i)) {
        var s = this._header["content-type"], a = this._serializer || m.serialize[s ? s.split(";")[0] : ""];
    ...
    function s(e) {
      "" !== e.message && _ && (_._readyState = d, _.dispatchEvent({type: "error", message: e.errMsg}))
    }
    ...
    }(), u = n(21), c = n(20), l = 0, f = 1, h = 2, d = 3, p = ["openSidebar", "error", "message", "close"], _ = void 0, v = function (e) {
      function t(e, n) {
        ...
        return o._url = e, o._protocal = "", o._readyState = l, _ && _.dispatchEvent({type: "close"}), _ = o, wx.onSocketOpen(function (e) {
          _ && (_._readyState = f, _.dispatchEvent({type: "openSidebar"}))
    ...
    var u = function () {
      ...
      }(), c = n(21), l = n(20), f = n(9), h = 0, d = 1, p = 2, _ = 3, v = 4,
      y = ["abort", "error", "load", "loadstart", "progress", "timeout", "loadend", "readystatechange"], m = function (e) {
        function t() {
          i(this, t);
        ...
        return s(t, e), u(t, [{
          ...
          key: "openSidebar", value: function (e, t) {
    ...
    "use strict";
    var r = n(10), i = n(53), o = n(54), s = r.LISTENERS, a = r.CAPTURE, u = r.BUBBLE, c = r.ATTRIBUTE, l = r.newNode, f = i.defineCustomEventTarget,
      h = o.createEventWrapper, d = o.STOP_IMMEDIATE_PROPAGATION_FLAG, p = "undefined" != typeof window && "undefined" != typeof window.EventTarget,
    ...
    (function (t) {
      var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        return e && "function" == typeof Symbol && e.constructor === Symbol ? "symbol" : typeof e
      }, i = n(12), o = n(15), s = n(9), a = n(14), u = n(13);
      e.exports = {
        polyfill: function () {
          ...
          var n = {localStorage: i, XMLHttpRequest: o, FormData: s, WebSocket: a, Object: Object, navigator: u};
    ...
    "use strict";
    var r = n(0), i = n(42), o = n(43), s = n(44), a = n(3), u = n(2).request, c = n(1), l = n(4), f = l.tap, h = n(5)("leancloud:file");
    e.exports = function (e) {
      ...
      e.File = function (t, i, o) {
        ...
        if (this.attributes.metaData = {owner: s ? s.id : "unknown"}, this.set("mime_type", o), r.isArray(i) && (this.attributes.metaData.size = i.length, i = {base64: p(i)}), i && i.base64) {
          var a = n(47), u = a(i.base64, o);
          this._source = c.resolve({data: u, type: o})
        ...
        className: "_File", _toFullJSON: function (t) {
          ...
          var n = arguments.length <= 1 || void 0 === arguments[1] ? "fileTokens" : arguments[1], r = this.attributes.name, i = l(r);
          !i && this._extName && (r += this._extName, i = this._extName);
          var o = t() + t() + t() + t() + t() + i, s = {key: o, name: r, ACL: this._acl, mime_type: e, metaData: this.attributes.metaData};
          ...
          u("fileCallback", null, null, "post", {token: this._token, result: e}).catch(h), delete this._token
        }, fetch: function (e) {
    ...
    e.exports = function (e) {
      e.GeoPoint = function (t, n) {
        ...
        toJSON: function () {
          ...
          var t = Math.PI / 180, n = this.latitude * t, r = this.longitude * t, i = e.latitude * t, o = e.longitude * t, s = n - i, a = r - o,
            u = Math.sin(s / 2), c = Math.sin(a / 2), l = u * u + Math.cos(n) * Math.cos(i) * c * c;
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      return e && "function" == typeof Symbol && e.constructor === Symbol ? "symbol" : typeof e
    }, i = n(6), o = n(2), s = function (e, t, n, r) {
    ...
    e.exports = function (e) {
      e.Insight = e.Insight || {}, r.extend(e.Insight, {
        startJob: function (t, n) {
          ...
          var r = {jobConfig: t, appId: e.applicationId}, i = o("bigquery", "jobs", null, "POST", e._encode(r, null, !0), n);
            ...
            var a = e.Promise.resolve(r.map(t, function (t) {
              ...
              return o("batch", null, null, "POST", {
                requests: r.map(t, function (e) {
                  ...
                  return e.id && (i = i + "/" + e.id, n = "PUT"), e._startSave(), {method: n, path: i, body: t}
                })
              }, s).then(function (n) {
                var r;
          ...
          if (t) {
            ...
            if (t instanceof e.Op.Relation) {
              ...
              var n = r.union(r.difference(t.relationsToAdd, this.relationsToRemove), this.relationsToAdd),
                i = r.union(r.difference(t.relationsToRemove, this.relationsToAdd), this.relationsToRemove), o = new e.Op.Relation(n, i);
    ...
    "use strict";
    var r = n(0), i = n(5)("leancloud:query"), o = n(1), s = n(3), a = n(2).request, u = n(4), c = u.ensureArray, l = function (e, t) {
    ...
    e.exports = function (e) {
      e.Query = function (t) {
        ...
        _processResult: function (e) {
          ...
          var e = this, t = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], n = t.orderedBy, s = t.batchSize, u = arguments[1],
            c = this.toJSON();
          ...
          return {
            next: function () {
              return l = l.then(function (t) {
                return h ? [] : t.length > 1 ? t : f || 0 === t.length ? a("scan/classes", e.className, null, "GET", f ? r.extend({}, c, {cursor: f}) : c, u).then(function (t) {
    ...
    e.exports = function (e) {
      e.SearchSortBuilder = function () {
        ...
        _addField: function (e, t, n, r) {
          var i = {};
          return i[e] = {order: t || "asc", mode: n || "avg", missing: "_" + (r || "last")}, this._sortFields.push(i), this
          ...
          n = n || {};
          var r = {}, i = {lat: t.latitude, lon: t.longitude}, o = {order: n.order || "asc", mode: n.mode || "avg", unit: n.unit || "km"};
    ...
    e.exports = function (e) {
      ...
      e.Status = function (e, t) {
        ...
        _objectClass: e.Status, _sinceId: 0, _maxId: 0, _inboxType: "default", _owner: null, _newObject: function () {
          return new e.Status
        }, _createRequest: function (e, t) {
    ...
    e.exports = function (e) {
      e.User = e.Object.extend("_User", {
        _isCurrentUser: !1, _mergeMagicFields: function (t) {
          ...
          var r = "users/" + this.id + "/updatePassword", i = {old_password: e, new_password: t}, s = o(r, null, null, "PUT", i, n);
          return s
        }, isCurrent: function () {
        ...
        _currentUser: null, _currentUserMatchesDisk: !1, _CURRENT_USER_KEY: "currentUser", _authProviders: {}, signUp: function (t, n, r, i) {
    ...
    (function (t) {
      !function (t, n) {
        ...
        var Q = V, K = 0, z = void 0, G = void 0, H = function (e, t) {
            te[K] = e, te[K + 1] = t, K += 2, 2 === K && (G ? G(f) : ne())
          }, $ = "undefined" != typeof window ? window : void 0, X = $ || {}, Y = X.MutationObserver || X.WebKitMutationObserver,
        ...
        var re = Math.random().toString(36).substring(16), ie = void 0, oe = 1, se = 2, ae = new C, ue = new C, ce = 0;
    ...
    t.STOP_IMMEDIATE_PROPAGATION_FLAG = i, t.createEventWrapper = function (e, t) {
      ...
      return r[i] = {value: !1, writable: !0}, r[o] = {
        value: !1,
        writable: !0
      }, r[s] = {value: e}, "undefined" != typeof e.detail && (r.detail = {value: e.detail, enumerable: !0}), Object.create(Object.create(e, a), r)
    }
  }, function (e, t) {
    function n(e) {
    ...
    !function () {
      var t = n(49), r = n(19).utf8, i = n(55), o = n(19).bin, s = function (e, n) {
